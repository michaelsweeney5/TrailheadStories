<?php
/**
 * Page to manage staff users.
 * If the user is an Admin they are able to see a list of all users and edit any of them.
 * If normal Staff user this will only display an edit form for their user.
 */
session_start();
